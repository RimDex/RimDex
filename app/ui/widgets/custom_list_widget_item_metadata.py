...
from app.mods.mod_utils import resolve_workshop_updated_timestamp
...
class CustomListWidgetItemMetadata:
    ...
    def __init__(
        ...
        # Workshop update timestamp (always populated so data is ready when the
        # indicator is toggled on; None for non-workshop mods).
