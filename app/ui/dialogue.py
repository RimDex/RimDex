...
def _get_parent_if_constrain_enabled(parent: QWidget | None = None) -> QWidget | None:
    ...
    if (
        parent is None
        and context.main_window is not None
        and context.settings is not None
        and context.settings.constrain_dialogues_to_main_window_monitor
    ):
...
def show_internet_connection_error(
    ...
    show_information(
        ...
        information=(
            ...
            "If you are connected but still see this message, your firewall or security software may be blocking RimDex. <br>"
            "To resolve this issue: <br><br>"
            "Add RimDex to your firewall's allowed applications. <br>"
        ...
        details=(
            ...
            "Find RimDex or add it manually if needed. <br>"
...
class FatalErrorDialog(_BaseDialogue):
    ...
    def __init__(
        ...
        self.open_log_btn.clicked.connect(
            lambda: platform_specific_open(AppInfo().user_log_folder)
        )
...
class SettingsFailureDialog(QDialog):
    ...
    def __init__(self) -> None:
        ...
        def _open_settings_file() -> None:
            platform_specific_open(AppInfo().app_settings_file)
