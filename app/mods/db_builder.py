...
class DatabaseBuilder(QObject):
    ...
    _instance: "DatabaseBuilder | None" = None
    ...
    def _do_build_database_thread(self) -> None:
        ...
        self._setup_query_runner(f"RimDex - DB Builder ({mode})")
    ...
    def _do_download_entire_workshop(self, action: str) -> None:
        ...
        self._setup_query_runner("RimDex - DB Builder PublishedFileIDs query")
        self.db_builder.start()
    ...
    def _do_merge_databases(self) -> None:
        ...
        try:
            ...
            dialogue.show_warning(
                ...
                information=self.tr("Error: {}").format(e),
            )
