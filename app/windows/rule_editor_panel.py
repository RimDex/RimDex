...
from app.core.ui_helpers import assign_event_handler
from app.models.metadata.metadata_structure import AboutXmlMod, ExternalRulesSchema
...
class RuleEditor(QWidget):
    ...
    def _rules_schema_to_dict(
        schema: ExternalRulesSchema | None,
    ) -> dict[str, Any]:
    ...
    def __init__(
        ...
        assign_event_handler(
            ...
            "dropEvent",
            self.createDropEvent(self.external_community_rules_loadAfter_list),
        )
        ...
        assign_event_handler(
            ...
            "dropEvent",
            self.createDropEvent(self.external_community_rules_loadBefore_list),
        )
        ...
        assign_event_handler(
            ...
            "dropEvent",
            self.createDropEvent(self.external_user_rules_loadAfter_list),
        )
        ...
        assign_event_handler(
            ...
            "dropEvent",
            self.createDropEvent(self.external_user_rules_loadBefore_list),
        )
        ...
        if type(self.mods_search_clear_button) is not QToolButton:
            raise Exception(  # noqa: TRY002
                "Failed to find clear button in QLineEdit"
            )
