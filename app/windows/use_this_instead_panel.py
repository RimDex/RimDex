...
class UseThisInsteadPanel(BaseModsPanel):
    ...
    def _filter_alternatives(self) -> dict[str, ReplacementInfo]:
        """
        ...
        """
        try:
            alternatives: dict[str, ReplacementInfo] = {}
    ...
    def _group_mods_by_package_id(
        self, alternatives: dict[str, ReplacementInfo]
    ...
    def _add_group_to_table(
        ...
        replacement = originals[0].replacement
        assert replacement is not None
        self._add_replacement_mod(
            replacement, package_id, current_row + 1 + len(originals)
        )
    ...
    def _create_replacement_mod_info(self, mod_replacement: ReplacementInfo) -> "ModInfo":
        """
    ...
    def _add_replacement_mod(
        self, mod_replacement: ReplacementInfo, package_id: str, current_row: int
    ) -> None:
        """
