...
from app.ui.widgets.button_factory import ButtonConfig, ButtonType, MenuItem
...
class GitHubModsPanel(BaseModsPanel):
    ...
    def __init__(
        ...
        self._update_worker: GitHubUpdateCheckWorker | None = None
        self._auto_update_signals_blocked = False

        super().__init__(
            object_name="githubModsPanel",
            window_title=self.tr("RimDex - GitHub Mods"),
    ...
    def _on_check_updates_finished(self, updates: list[GitHubModEntry]) -> None:
