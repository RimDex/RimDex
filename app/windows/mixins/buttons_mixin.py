...
class ButtonsMixin:
    ...
    def _create_workshop_button(
        ...
        self._configure_button(
            button,
            self.tr("Open Page"),  # type: ignore[attr-defined]
            object_name,
    ...
    def _create_deletion_button(self, config: ButtonConfig) -> QPushButton:
        ...
        """
        button = QPushButton()
        button.setText(self.tr("Delete"))  # type: ignore[attr-defined]
        button.setObjectName("dangerButton")
        deletion_menu = ModDeletionMenu(
            settings=self.settings,
            get_selected_mod_metadata=self._get_selected_mod_metadata,  # type: ignore[attr-defined]
            metadata_controller=self.metadata_controller,
            completion_callback=config.completion_callback
            or self._refresh_metadata_and_panel,  # type: ignore[attr-defined]
