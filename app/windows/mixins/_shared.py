...
class TrMixin:
    ...
    def tr(self, source_text: str, *args: Any, **kwargs: Any) -> str:
        return super().tr(source_text, *args, **kwargs)  # type: ignore[misc]

    def close(self, *args: Any, **kwargs: Any) -> Any:
        return super().close(*args, **kwargs)  # type: ignore[misc]

    def setObjectName(self, name: str) -> None:
        super().setObjectName(name)  # type: ignore[misc]

    def setWindowTitle(self, title: str) -> None:
        super().setWindowTitle(title)  # type: ignore[misc]

    def setLayout(self, layout: Any) -> None:
        super().setLayout(layout)  # type: ignore[misc]

    def resize(self, *args: Any, **kwargs: Any) -> None:
        super().resize(*args, **kwargs)  # type: ignore[misc]

    def installEventFilter(self, filterObj: Any) -> None:
        super().installEventFilter(filterObj)  # type: ignore[misc]
