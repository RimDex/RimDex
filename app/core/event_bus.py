...
class EventBus(QObject):
    ...
    # Emitted by Settings when the persisted file is corrupted; payload is a
    # dict of already-translated dialog strings + use_old_backup flag. The UI
    # layer (not the model) shows the recovery dialog / exits.
    settings_corrupted = Signal(dict)
    ...
    do_open_translation_manager = Signal()
