...
from app.core.schema import generate_rimworld_mods_list
from app.io.xml import json_to_xml_write
...
class ImportExportService:
    ...
    def build_rentry_report(
        ...
        report = (
            "# RimWorld mod list       "
            "![](https://github.com/RimDex/RimDex/blob/main/docs/rentry_preview.png?raw=true)"
