...
from app.core.constants import RIMWORLD_PACKAGE_IDS
    ...
    def write_snapshot(
        ...
        payload: dict[str, Any] = {
            ...
            _META_KEY: {
                ...
                "rimdexVersion": AppInfo().app_version,
        ...
        return Snapshot(
            ...
            short_id=short_id,
            timestamp=timestamp,
            rimdex_version=AppInfo().app_version,
    ...
    def load_snapshot(self, path: str | Path) -> Snapshot:
        ...
        if isinstance(meta, dict):
            ...
            return Snapshot(
                ...
                rimdex_version=str(meta.get("rimdexVersion") or ""),
        ...
        # Fall back: a plain RimDex JSON mod list without our metadata block.
