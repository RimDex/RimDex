...
from app.ui.widgets.custom_qlabels import AdvancedClickableQLabel
...
class ModsPanel(QWidget):
    ...
    def initialize_active_mods_search_widgets(self) -> None:
        ...
        self.updated_text.setToolTip(
            self.tr("Click to only show mods recently updated on the Workshop")
        )
    ...
    def recalculate_list_errors_warnings(self, list_type: str) -> None:
        ...
        if list_type == "Active":
            ...
            # Count recently-updated mods. Only if indicator is enabled.
            updated_count = 0
            ...
            # Include updated mods in summary frame visibility
            if updated_count > 0:
