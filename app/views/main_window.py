...
class MainWindow(QMainWindow):
    ...
    def __switch_to_instance(self, instance: str) -> None:
        ...
        instance_path = str(Instance.get_instance_folder_path(instance))
