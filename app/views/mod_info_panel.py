...
from app.core.generic import format_file_size, platform_specific_open, scanpath
...
class ModInfoPanel:
    ...
    def __init__(
        ...
        self.mod_info_color = QHBoxLayout()
        ...
        self.mod_info_name_label = QLabel(
            QCoreApplication.translate("ModInfo", "Name:")
        )
        ...
        self.scenario_info_summary_label = QLabel(
            QCoreApplication.translate("ModInfo", "Summary:")
        )
        ...
        self.mod_info_package_id_label = QLabel(
            QCoreApplication.translate("ModInfo", "PackageID:")
        )
        ...
        self.mod_info_author_label = QLabel(
            QCoreApplication.translate("ModInfo", "Authors:")
        )
        ...
        self.mod_info_tags_label = QLabel(
            QCoreApplication.translate("ModInfo", "Tags:")
        )
        ...
        self.mod_info_color_label = QLabel(
            QCoreApplication.translate("ModInfo", "Color:")
        )
        self.mod_info_color_label.setObjectName("summaryLabel")
        self.mod_info_color_value = QLabel("")
        self.mod_info_color_value.setObjectName("summaryValue")
        self.mod_info_color_value.setTextInteractionFlags(
            Qt.TextInteractionFlag.TextSelectableByMouse
        )

        self.mod_info_mod_version_label = QLabel(
            QCoreApplication.translate("ModInfo", "Mod Version:")
        )
        ...
        self.mod_info_supported_versions_label = QLabel(
            QCoreApplication.translate("ModInfo", "Supported Version:")
        )
        ...
        self.mod_info_folder_size_label = QLabel(
            QCoreApplication.translate("ModInfo", "Folder Size:")
        )
        ...
        self.mod_info_path_label = QLabel(
            QCoreApplication.translate("ModInfo", "Path:")
        )
        ...
        self.mod_info_steam_url_label = QLabel(
            QCoreApplication.translate("ModInfo", "Steam URL:")
        )
        ...
        self.mod_info_github_source_label = QLabel(
            QCoreApplication.translate("ModInfo", "GitHub:")
        )
        ...
        self.mod_info_github_version_label = QLabel(
            QCoreApplication.translate("ModInfo", "Version:")
        )
        ...
        self.mod_info_last_touched_label = QLabel(
            QCoreApplication.translate("ModInfo", "Last Touched:")
        )
        ...
        self.mod_info_filesystem_time_label = QLabel(
            QCoreApplication.translate("ModInfo", "Filesystem Modified:")
        )
        ...
        self.mod_info_external_times_label = QLabel(
            QCoreApplication.translate("ModInfo", "Workshop Times:")
        )
        ...
        self.description_text = QCoreApplication.translate(
            "ModInfo", "Welcome to RimDex!"
        )
        ...
        self.notes.setPlaceholderText(
            QCoreApplication.translate("ModInfo", "Put your personal mod notes here!")
        )
        ...
        self._add_label_value_to_layout(
            self.mod_info_color, self.mod_info_color_label, self.mod_info_color_value
        )
        ...
        self.mod_info_layout.addLayout(self.mod_info_color)
        ...
        self.base_mod_info_widgets = [
            ...
            self.mod_info_color_label,
            self.mod_info_color_value,
    ...
    def show_github_info(
        ...
        if update_available:
            self.mod_info_github_update_label.setText(
                QCoreApplication.translate("ModInfo", "(Update available)")
            )
    ...
    def _set_mod_tags_info(self, mod_metadata: dict[str, Any]) -> None:
        """Set user-defined tags information from metadata dict (already fetched from aux DB)."""
        tags = mod_metadata.get("mod_tags", [])
        ...
        if tags:
            ...
            self.mod_info_tags_value.setText(
                QCoreApplication.translate("ModInfo", "None")
            )
            self.mod_info_tags_value.setToolTip("")

    def _set_mod_color_info(self, mod_metadata: dict[str, Any]) -> None:
        """Set mod color information from metadata dict (already fetched from aux DB)."""
        color_hex = mod_metadata.get("mod_color_hex")

        if color_hex:
            color = QColor(color_hex)
            if color.isValid():
                self.mod_info_color_value.setText(color_hex)
                self.mod_info_color_value.setStyleSheet(
                    f"background: {color_hex}; color: {'white' if color.lightness() < 128 else 'black'};"
                )
                self.mod_info_color_value.setToolTip(color_hex)
                return

        self.mod_info_color_value.setText(QCoreApplication.translate("ModInfo", "None"))
        self.mod_info_color_value.setStyleSheet("")
    ...
    def _set_mod_info_fields(
        ...
        self._set_mod_tags_info(mod_metadata)
        ...
        # Set color
        self._set_mod_color_info(mod_metadata)
    ...
    def _build_mod_metadata_dict(self, uuid: str, mod: ListedMod) -> dict[str, Any]:
        ...
        # Get timestamps and cached aux fields from aux DB (single query)
        ...
        if aux_entry is not None:
            ...
            raw_tags = aux_entry.__dict__.get("tags")
            if raw_tags and isinstance(raw_tags, list):
                metadata["mod_tags"] = sorted(tag.tag for tag in raw_tags)
            else:
                metadata["mod_tags"] = []
            metadata["mod_color_hex"] = aux_entry.__dict__.get("color_hex")
