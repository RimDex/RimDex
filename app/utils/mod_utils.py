...
MOD_TYPE_TO_FILTER_SOURCE: dict[ModType, str] = {
...
# Display-oriented: human-readable labels shown in the mod-info panel and
# context menus (each ModType gets its own distinct string).
MOD_TYPE_TO_DISPLAY_SOURCE: dict[ModType, str] = {
    ModType.LUDEON: "expansion",
    ModType.LOCAL: "Local",
    ModType.STEAM_WORKSHOP: "Steam",
    ModType.STEAM_CMD: "SteamCMD",
    ModType.GIT: "git",
}
