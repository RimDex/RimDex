...
class SteamBrowser(QWidget):
    ...
    def _add_collection_or_mod_to_list(self) -> None:
        ...
        publishedfileid = publishedfileid.split("#")[0].split("&")[0]
        ...
        if "collectionItemDetails" not in self.current_html:
            ...
            if len(collection_mods_pfid_to_title) > 0:
                ...
                show_warning(
                    ...
                    information=self.tr(
                        "Please reach out to us on Github Issues page or<br>#rimdex-testing on the Rocketman/CAI discord"
                    ),
                )
