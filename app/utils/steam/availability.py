...
from app.core.ui_helpers import show_no_steam_warning, show_snap_steam_warning
from app.utils.steam.steamworks.wrapper import _create_steamworks
...
def _is_steam_running() -> bool:
    ...
    try:
        ...
        for attempt in range(5):
            try:
                processes = list(psutil.process_iter(attrs=["name"]))
            except psutil.Error:
                sleep(2)
                continue
    ...
    try:
        ...
        for attempt in range(MAX_ATTEMPTS):
            ...
            try:
                ...
                test_steamworks = _create_steamworks(_libs)
                try:
