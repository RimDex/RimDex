...
def show_no_steam_warning() -> None:
    ...
    dialogue.show_warning(
        ...
        information=translate(
            "SteamworksInterface",
            "RimDex could not detect steam client or it may be unresponsive."
        ...
        details=translate(
            "SteamworksInterface",
            "If you still facing issues even after steam installed and running, please report this issue to https://github.com/RimDex/RimDex/issues",
        ),
    )
