...
from app.net.http import DEFAULT_TIMEOUT
        ...
        try:
            ...
            show_fatal_error(
                ...
                text=QCoreApplication.translate(
                    "RentryUpload", "An error occurred: {e}"
                ).format(e=str(e)),
            )
...
class RentryImport:
    ...
    def input_dialog(self) -> None:
        ...
        self.link_input = QInputDialog.getText(
            None,
            QCoreApplication.translate("RentryImport", "Enter Rentry.co link"),
            QCoreApplication.translate("RentryImport", "Enter the Rentry.co link:"),
        )
    ...
    def import_rentry_link(self) -> None:
        ...
        if not self.is_valid_rentry_link(rentry_link):
            ...
            show_warning(
                title=QCoreApplication.translate("RentryImport", "Invalid Rentry Link"),
                text=QCoreApplication.translate(
                    "RentryImport",
        ...
        try:
            ...
            show_fatal_error(
                ...
                text=QCoreApplication.translate(
                    "RentryImport", "An error occurred: {e}"
                ).format(e=str(e)),
            )
...
class RentryError:
    ...
    def show_response_error(self, response: requests.Response) -> None:
        ...
        InformationBox(
            title=QCoreApplication.translate(
                "RentryError", "Failed to fetch Rentry Content"
            ),
            text=QCoreApplication.translate(
                "RentryError", "Rentry returned status code: {code}"
    ...
    def show_missing_rentry_auth_warning(self) -> None:
        ...
        show_warning(
            title=QCoreApplication.translate(
                "RentryError", "Rentry Auth Code Not Found"
            ),
            text=QCoreApplication.translate(
