...
class TranslationController(QObject):
    ...
    def __init__(
        ...
        # Hook into the MainContent root manager so MainWindow.closeEvent
        # tears this dialog (and its worker threads) down on app exit.
        if window_manager is not None:
            window_manager.register_manager(self._window_manager)
