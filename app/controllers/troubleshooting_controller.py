...
class TroubleshootingController:
    ...
    def _on_integrity_apply_button_clicked(self) -> None:
        ...
        if not show_dialogue_conditional(
            QCoreApplication.translate("TroubleshootingController", "Confirm Changes"),
    ...
    def _on_clear_mods_button_clicked(self) -> None:
        ...
        if not show_dialogue_conditional(
            title=QCoreApplication.translate(
                "TroubleshootingController", "Confirm Clear"
            ),
            text=QCoreApplication.translate(
                "TroubleshootingController",
...
<ModsConfigData>
  ...
  <knownExpansions>
                ...
                show_dialogue_conditional(
                    title=QCoreApplication.translate(
                        "TroubleshootingController", "Error"
                    ),
                    text=QCoreApplication.translate(
    ...
    def _on_mod_export_list_button_clicked(self) -> None:
        ...
        if not mods_config.exists():
            ...
            show_warning(
                title=QCoreApplication.translate(
                    "TroubleshootingController", "Export failed"
                ),
                text=QCoreApplication.translate(
                    "TroubleshootingController",
        ...
        save_path = show_dialogue_file(
            title=QCoreApplication.translate(
                "TroubleshootingController", "Export Mod List"
            ),
        ...
        if not show_dialogue_conditional(
            QCoreApplication.translate("TroubleshootingController", "Confirm Export"),
            QCoreApplication.translate(
    ...
    def _on_mod_import_list_button_clicked(self) -> None:
        ...
        if not mods_config.exists():
            ...
            show_warning(
                title=QCoreApplication.translate(
                    "TroubleshootingController", "Import failed"
                ),
                text=QCoreApplication.translate(
                    "TroubleshootingController",
        ...
        import_path = show_dialogue_file(
            title=QCoreApplication.translate(
                "TroubleshootingController", "Import Mod List"
            ),
            directory=str(config_dir),
            file_type="File",
        ...
        if not show_dialogue_conditional(
            QCoreApplication.translate("TroubleshootingController", "Confirm Import"),
            QCoreApplication.translate(
                "TroubleshootingController", "Import mod list from file?"
            ),
            QCoreApplication.translate(
                "TroubleshootingController",
        ...
        try:
            ...
            show_warning(
                ...
                information=QCoreApplication.translate(
                    ...
                    "Expected RimWorld ModsConfig XML or RimDex JSON export.<br>"
                    "Details: {e}",
                ).format(e=str(e)),
            )
        except Exception as e:
    ...
    def _find_steam_path(self) -> Path:
        ...
        if not steam_path:
            raise Exception(  # noqa: TRY002
                f"Steam installation not found: {steam_path}"
            )
    ...
    def _on_steam_clear_cache_clicked(self) -> None:
        ...
        try:
            ...
            if downloading_folder.exists():
                ...
                show_dialogue_conditional(
                    title=QCoreApplication.translate(
                        "TroubleshootingController", "Cache Cleared"
                    ),
                    text=QCoreApplication.translate(
                        "TroubleshootingController",
                ...
                show_dialogue_conditional(
                    title=QCoreApplication.translate(
                        "TroubleshootingController", "Cache Clear"
                    ),
                    text=QCoreApplication.translate(
                        "TroubleshootingController",
            ...
            show_dialogue_conditional(
                title=QCoreApplication.translate(
                    "TroubleshootingController", "Cache Clear Failed"
                ),
                text=QCoreApplication.translate(
                    "TroubleshootingController",
    ...
    def _get_steam_library_file(self) -> Path:
        ...
        if not library_file.exists():
            raise Exception(  # noqa: TRY002
                f"Steam library file not found: {library_file}"
            )
        return library_file
    ...
    def _on_steam_repair_library_clicked(self) -> None:
        ...
        try:
            ...
            if not app_ids:
                show_dialogue_conditional(
                    title=QCoreApplication.translate(
                        "TroubleshootingController", "No Games Found"
                    ),
                    text=QCoreApplication.translate(
                        "TroubleshootingController",
    ...
    def _on_steam_cleanup_orphaned_workshop_clicked(self) -> None:
        ...
        if not acf_path.exists():
            show_warning(
                title=QCoreApplication.translate(
                    "TroubleshootingController", "ACF File Not Found"
                ),
                text=QCoreApplication.translate(
                    "TroubleshootingController",
        ...
        try:
            ...
            show_warning(
                title=QCoreApplication.translate(
                    "TroubleshootingController", "Cleanup Failed"
                ),
                text=QCoreApplication.translate(
                    "TroubleshootingController",
    ...
    def show_location_warning(self) -> None:
        show_information(
            title=QCoreApplication.translate(
                "TroubleshootingController", "Location Error"
            ),
            text=QCoreApplication.translate(
                "TroubleshootingController",
    ...
    def show_failed_warning(self, item: Path | str, e: Exception) -> None:
        show_warning(
            title=QCoreApplication.translate(
                "TroubleshootingController", "Process failed"
            ),
            text=QCoreApplication.translate(
