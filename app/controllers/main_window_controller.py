...
class MainWindowController(QObject):
    ...
    def check_dependencies(self) -> None:
        ...
        # shared resolver (app.services.dependency_resolver) so there is a single
        # source of truth and no drift between the two implementations.
        ...
        if selected_deps:
            ...
            for dep_id in selected_deps:
                ...
                # If not found locally, try resolving the Workshop ID from
                # the Steam DB / mod About.xml via the dependency resolver.
                ...
                logger.debug(
                    f"Could not resolve a Workshop ID for missing dependency: {dep_id}"
                )
