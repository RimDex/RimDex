...
from app.ui.dialogue import BinaryChoiceDialog, show_dialogue_file
        ...
        if not is_valid:
            QMessageBox.information(
                ...
                QCoreApplication.translate(
                    "LocationsTabController", "Invalid Game Location"
                ),
                error_msg,
            )
            return None
    ...
    def _on_config_choose(self, dialog: SettingsDialog) -> str | None:
        ...
        if not is_valid:
            QMessageBox.warning(
                dialog,
                QCoreApplication.translate(
                    "LocationsTabController", "Invalid Config Folder"
                ),
                error_msg,
            )
            return None
    ...
    def _on_local_mods_choose(self, dialog: SettingsDialog) -> str | None:
        ...
        if not is_valid:
            QMessageBox.warning(
                dialog,
                QCoreApplication.translate(
                    "LocationsTabController", "Invalid Local Mods Folder"
                ),
                error_msg,
            )
            return None
        ...
        if not skip_confirmation:
            answer = BinaryChoiceDialog(
                title=QCoreApplication.translate(
                    "LocationsTabController", "Clear all locations"
                ),
