...
from app.core.ui_helpers import restart_application
        ...
        if new_language != settings.language:
            ...
            answer = dialogue.show_dialogue_conditional(
                title=QCoreApplication.translate(
                    "LanguageController", "Language Changed"
                ),
                text=QCoreApplication.translate(
                    "LanguageController", "The language has been updated."
                ),
                ...
                button_text_override=[
                    QCoreApplication.translate("LanguageController", "Restart"),
                ],
            )
