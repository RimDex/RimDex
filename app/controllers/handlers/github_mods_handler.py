...
class GitHubModsHandler:
    ...
    def _on_github_update_check_finished(self, updates: list[UpdateAvailable]) -> None:
        ...
        if manual:
            ...
            InformationBox(
                ...
                text=self._tr(
                    "{count} GitHub mod(s) have updates available."
                ).format(count=len(manual)),
    ...
    def open_github_mods_panel(self) -> None:
        ...
        self._view.window_manager.register(self._github_mods_panel)  # type: ignore[attr-defined]
    ...
    def do_git_install_mod(self) -> None:
        args, ok = QInputDialog().getText(
            self._view.mods_panel,  # type: ignore[attr-defined]
