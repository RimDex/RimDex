...
請嘗試以管理員權限運行 RimDex 或檢查資料夾權限。</translation>
    </message>
    <message>
...
Would you like to configure them now?</source>
        <translation>RimDex 至少需要設置遊戲安裝資料夾和配置資料夾路徑，並且路徑都存在。請手動設置或使用自動檢測功能。
...
是否要現在配置它們？</translation>
    ...
    <message>
        ...
        <translation>你需要在下載完成後重新進行 Rentry 導入。如果下載完成後仍有缺失的模組，它們會顯示在缺失模組面板中。如果 RimDex 仍然無法下載某些模組，說明這些模組的數據在 Rentry 鏈接和 steam 資料庫中都不可用。</translation>
    </message>
    <message>
...
{ret}</translation>
    ...
    <message>
        ...
        <translation>RimDex 無法查詢 Steam WebAPI 以獲取更新資訊！
</translation>
    </message>
    <message>
...
如果你剛剛安裝了 Git，請重新啟動 RimDex 以使 PATH 更改生效。</translation>
    </message>
    <message>
...
從 Steam 獲取模組需要 PublishedFileID！</translation>
    ...
    <message>
        ...
        <translation>警告：不建議通過 Steam 一次性訂閱這麼多模組。Steam 有意無意地設置了 API 訂閱的限制。強烈建議你使用 SteamCMD 下載這些模組到 SteamCMD 前綴目錄中。這可能會因為速率限制而花費更長時間，但你可以使用單獨的、經過身份驗證的 SteamCMD 實例重新使用由 RimDex 生成的腳本，如果你不想通過 RimDex 匿名下載。</translation>
    </message>
    <message>
...
正在使用緩存但已過期的 Steam 資料庫。</translation>
    ...
    <message>
        ...
        <translation>RimDex 無法在預期路徑獲取遊戲版本：[{version_file_path}]。</translation>
    </message>
    <message>
        <source>
...
<context>
    ...
    <message>
        ...
        <translation>保存規則到 RulesDatabase.json</translation>
    </message>
    <message>
...
這可能避免在下載模組時出現的一些問題，例如下載失敗以及已刪除模組重新生成的情況。</translation>
    ...
    <message>
        ...
        <translation>某些設置需要重啟 RimDex</translation>
    </message>
    <message>
...
（此設置同樣適用於RimDex外的刪除操作）</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>RimDex 無法在配置的前綴中找到 SteamCMD 安裝：</translation>
    </message>
    <message>
