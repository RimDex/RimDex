...
# Load the shared translation fixtures (locales_tmp + autouse cache reset)
# so every test module gets them without duplicating the definitions.
pytest_plugins = ["tests.translation_fixtures"]
...
def mock_app_info(
    ...
    stub._application_backups_folder = storage / "backups" / "rimdex_installation"
