"""Tests for app.mods.mod_utils — mod utility functions."""
...
from app.mods.mod_utils import (
...
def metadata_controller_mock() -> Generator[MagicMock, None, None]:
    with patch("app.mods.mod_utils.MetadataController.instance") as mock_instance:
        mock = MagicMock()
