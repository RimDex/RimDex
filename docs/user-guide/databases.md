...
## Working with databases via RimDex Git integration
...
1. [Create a remote repository](https://docs.github.com/en/get-started/quickstart/create-a-repo), or use an existing repository. GitHub repositories have additional optional integration within RimDex.

2. Configure the repository URL in RimDex via the Settings panel under `Databases`.

3. **Optional!** Configure your GitHub identity in RimDex under `Advanced`. You will need to know your GitHub username, as well as have a personal access token created for RimDex with `Repo` permission granted.
...
### Cloning a database for use with RimDex:

{: .warning}
> This video is outdated and may not be accurate for the latest versions of RimDex.

<iframe width="420" height="315" src="https://github.com/RimDex/RimDex/assets/2766946/2c236e00-d963-4831-93e7-3effb10c6b5e" frameborder="0" allowfullscreen="true" alt="Download Database Demo Video"></iframe>
...
<iframe width="420" height="315" src="https://github.com/RimDex/RimDex/assets/2766946/60ced0ef-adba-436f-8fbc-e593a236e389" frameborder="0" allowfullscreen="true" alt="Upload Database Demo Video"></iframe>
