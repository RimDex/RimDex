...
- На аккаунте Steam обычно нужно потратить не менее $5 для доступа к WebAPI — так RimDex получает зависимости модов.
...
4. В RimDex: **Settings → DB Builder → Steam API Key**.
